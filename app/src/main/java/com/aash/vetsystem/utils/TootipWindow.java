...
public class TootipWindow {
    ...
    public TootipWindow(Context ctx) {
        this.ctx = ctx;
    ...
    public void showToolTip(View anchor, String msg) {
        ...
        int position_x = anchor_rect.centerX() - (contentViewWidth / 2)+50;
        int position_y = anchor_rect.bottom - (anchor_rect.height() / 2)+50;
